                ...
                <form className="bg-white rounded px-8 pt-6 pb-8 mb-4">
                      ...
                      >
                        <div className="flex">
                          {this.state.work.tags.map((tag, index) => {
                            return (
                              <div className="pl-1 pt-1" key={index}>
                                <p className="bg-gray-300 text-blue-800 font-medium text-sm shadow-sm rounded-full px-2">
                                  {tag.name}
                                </p>
                              </div>
                            );
                  ...
                  <div className="w-full mb-4 flex">
                    ...
                    <div className="flex lg:w-1/2 p-5">
                      <label className="pt-4 text-gray-600 text-sm font-semibold mb-2">
                        Assignee:
                      </label>
                      <div
                        className="p-2 cursor-pointer"
                        title="Tushar Chaudhari"
                      >
                        <img
                          alt="userprofile"
                    ...
                    <div className="flex">
                      ...
                      <div
                        className={
                          ...
                          " m-2 text-pink-500 border-pink-500 border-2 hover:text-white transition hover:bg-pink-500 font-semibold py-2 px-4 rounded focus:outline-none focus:shadow-outline cursor-pointer"
                        }
